...
def get_face_embeddings(image_np):
    ...
    for face in faces:
        ...
        face_discripter=facerec.compute_face_descriptor(image_np,shape,1)#128 embeddings
        encoding.append(np.array(face_discripter))
    return encoding
@st.cache_resource
...
def predict_attendance(class_image_np):
    ...
    for encoding in encodings:
        ...
        print("Distance Score:", best_match_score)
